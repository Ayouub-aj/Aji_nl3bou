<aside
    ...
    <div class="mt-auto space-y-2 border-t border-white/5 pt-4">
        ...
        <a class="flex items-center gap-3 text-gray-500 px-4 py-2 hover:text-[#b6a0ff] transition-colors" href="<?= URLROOT; ?>/logout">
