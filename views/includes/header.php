<header class="w-full top-0 sticky z-50 bg-[#0e0e0e] font-['Plus_Jakarta_Sans'] tracking-tight shadow-none">
    <div class="flex justify-between items-center px-8 py-4 w-full max-w-full mx-auto">
        <a href="/dashboard/Aji_nl3bou/" class="text-2xl font-bold tracking-tighter text-[#b6a0ff] hover:text-[#c9b8ff] transition-colors">The Curated Playroom</a>
        <nav class="hidden md:flex items-center gap-8">
            <a class="text-[#b6a0ff] font-bold border-b-2 border-[#b6a0ff] pb-1 transition-colors"
                href="/dashboard/Aji_nl3bou/">Explore</a>
        </nav>
        <div class="flex items-center gap-6">
            <div class="w-10 h-10 rounded-full bg-surface-container-highest overflow-hidden border border-[#b6a0ff]/20">
                <a href="/dashboard/Aji_nl3bou/login">
